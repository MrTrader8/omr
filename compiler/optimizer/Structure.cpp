...
void TR_RegionStructure::checkForInternalCycles()
   ...
   setContainsInternalCycles(findCycle(getEntry(), regionNodes, nodesSeenOnPath, nodesCleared, getNumber(), comp()));
